...
public class Int101Homework01 {
   ...
   static void work03UseOfUtilityClass() {
       ...
       System.out.println(calculateBMI(20.0,50.0));
   ...
   static void work04UseOfObjectClass() {
       ...
       Person B1 = new Person(30); 
       BankAccount ac1 = new BankAccount(15,B1);
       ac1.deposit(100);
       System.out.println(ac1);
       
       Person B2 = new Person(40);
       BankAccount ac2 = new BankAccount(20,B2);
       ac2.deposit(200);
      ...
      4.2 Create a public class named "BankAccount" in package named "work04".
          ...
          4.2.4 public getter methods for "owner" and "balance" fields.0
